...
?>
        ...
        */
        ...
        if($headerS['header_position'] != "header_top") do_action('ava_main_header_sidebar');
				 ...
				 $output .= "<div class='container av-logo-container'><div class='top-contacts-block'>
    					        <div class='phone'>
								Совместная работа - гарант роста<br>
			...
			echo "      
				...
				<!--<span style='text-decoration: underline;'><a style='color:red; margin-top:10px' href='https://wood-centr.ru/obratnaya-svyaz'>1 и 9 МАЯ ВЫХОДНОЙ</a></span>-->
				<!--<span style='text-decoration: underline; color: #ff0000;'>1 и 9 МАЯ ВЫХОДНОЙ</span>-->
						...
						*/
						    ...
						    { 
							    $output .= "<div class='top-address-block'>
							<p>
							<a href='tel:+78126037595'>+7 812 603 75 95</a>
							</p>
    			           	<p>
							<a href='mailto:info@aipr-rf.ru' target='_blank'>info@aipr-rf.ru</a>
							</p>
    			            </div></div>";  
								$output .= "</div>";
