...
// for google adwars/analystic call gtag_report_conversion function for reach a goal
const submitButtons = document.querySelectorAll('input.button[type="submit"]');
	submitButtons.forEach(elem => {
		elem.addEventListener('click', (e) => {
		gtag_report_conversion();
		console.log(e.target, 'reach a goal');
	})
});
</script>
...
<noscript><div><img src="https://mc.yandex.ru/watch/53777509" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
</body>
</html>
